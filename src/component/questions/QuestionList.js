...
export default function QuestionList() {
  ...
  const handleClick = (id) => {
    if (weAreOnNewCustomQuizPage(path)) toggleQuestionId(id);
  };
  ...
  const getQuestionsToDisplay = () => {
    return questions.slice(
      getDisplayedQuestionsStartIndex(),
      getDisplayedQuestionsStartIndex() + QUESTIONS_PER_PAGE
    );
  };
          ...
          <TBody>
            {getQuestionsToDisplay().map((question) => (
              ...
              >
                ...
                >
                  <LinedTableLink>{question.question}</LinedTableLink>
                </LinedTableLongTd>
                <ShortCenteredLinedTableTd>
                ...
                {!weAreOnUserPage() && (
                  <ShortCenteredLinedTableTd
                    onClick={(e) => {
                      window.open(`/users/${question.appUser.id}`, "_blank");
                      e.stopPropagation();
                    }}
                  >
